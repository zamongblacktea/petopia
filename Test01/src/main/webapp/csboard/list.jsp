...
<body>
	...
	<c:if test="${empty list }">
		<font color="red"> 작성한 문의글이 없습니다.</font>
	</c:if>

	<!--c:forEach문은 데이터가 있어야 출력이 된다. 데이터가 없는경우 forEach문 밖에서 해야함  -->
...
<%-- 	<a href="list.do?mem_idx=${sessionScope.user.mem_idx}">1:1 문의 내역 보기</a> --%>
	...
	<form method="get" action="csboard/list.do">
	  <input type="hidden" name="mem_idx" value="${sessionScope.user.mem_idx}">
		<div class="panel panel-info">  
	      <div class="panel-heading"><h4><b>${sessionScope.user.mem_id}</b>님의 문의:
	       ${vo.cs_title}
	      <!-- <div class="panel-body"> -->
		   ...
		   <div class="mycsboard" style="height: 200px;">${vo.cs_content}</div>
