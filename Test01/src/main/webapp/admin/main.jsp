...
<body>
	...
	<div id="box">
		...
		<!-- <div class="row" style="margin-top: 30px; margin-bottom: 5px;">
			...
			<div class="row">
			<div class="col-sm-8 menu" style="margin-top: 20px; margin-bottom: 5px;" >


			<input class="btn  btn-primary" style=" border-color:rgb(167,212,27); background: rgb(167,212,27);"type="button" value="1:1문의리스트"
				onclick="location.href='../csboard/list_all.do'">
				
			<input class="btn  btn-warning" type="button" value="전체숙소예약현황"
				onclick="location.href=''">	
			</div>
						
			<div id="logout" class="col-sm-4">
						...
						<tr>
							...
							<c:if test="${sessionScope.user.mem_grade eq '관리자' }">
								<td><input class="btn btn-info" type="button" value="수정"
									...
									<!-- 404가 떨어지지면 mem_idx넘어가는지 확인 --> <input
									class="btn btn-danger" type="button" value="삭제"
									onclick="del('${vo.mem_idx}');"> 
									<!-- 세션에있는 로그인한 user를"del('${user.mem_idx}');" 날림-->
								<!-- 회원을 삭제하려면 vo를 "del('${vo.mem_idx}');" 삭제해야함-->
