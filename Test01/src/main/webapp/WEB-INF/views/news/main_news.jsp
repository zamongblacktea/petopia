...
<body>
	...
	<div class="main_news_div_btn" onclick="location.href='../news/list_form.do?query=' + encodeURIComponent('강아지')">
		<img alt="강아지" class="main_news_btn_img"
			src="${ pageContext.request.contextPath }/resources/image/main_dog.jpg">
	</div>

	<div class="main_news_div_btn" onclick="location.href='../news/list_form.do?query=' + encodeURIComponent('고양이')">
		<img alt="고양이" class="main_news_btn_img"
			src="${ pageContext.request.contextPath }/resources/image/main_cat.jpg">
	</div>

	<div class="main_news_div_btn" onclick="location.href='../news/list_form.do?query=' + encodeURIComponent('반려동물행사')">
