...
public class RsvRoomVo {
	...
	public String getRoom_petType() {
		return room_petType;
	}



	public void setRoom_petType(String room_petType) {
		this.room_petType = room_petType;
	}
	...
	public int getTotal_rsv_chk() {
		return total_rsv_chk;
	}



	public void setTotal_rsv_chk(int total_rsv_chk) {
		this.total_rsv_chk = total_rsv_chk;
	}
