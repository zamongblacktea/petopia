...
<body>
	...
	<div class="header">
			...
			<input class="btn btn-danger" type="button" value="테스트"
				onclick="fnClick();">
		</div>
			<div class="col-sm-3 col-md-3">
			<input class="btn btn-danger" type="button" value="객실 입력"
				onclick="fnClick2();">
		</div>
	...
	<div class="content">
	 내용
	<div class="local">지역별 추천</div>
	<div class="lowprice">최저가 추천</div>
	<div class="news">
	...
	<p>주식회사 펫토피아 ｜ 공동대표 !Err404 박태섭 안소현 남가은 ｜ 서울특별시 관악구 청룡동 862-1 | http://www.gith.co.kr/</p> <br>
	<p>고객센터: 02-6020-0052 (평일 오전 9시 ~ 오후 6시)</p><br>
	<p>Petopia는 통신판매중개자로서 통신판매의 당사자가 아니며 상품 거래정보 및 거래 등에 대해 책임을 지지 않습니다.</p><br>
	<p>이용약관전자금거래 이용약관개인정보 처리방침</p><br>
